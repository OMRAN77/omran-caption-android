...
/**
 * Draws a small movable overlay window (translation text only, no buttons)
 * that stays on top of any other app, similar to the desktop overlay.
 * Fixed size; drag the text itself to reposition.
 */
object OverlayService {
    ...
    fun show(context: Context) {
        ...
        view.findViewById<View>(R.id.resizeHandle)?.visibility = View.GONE
